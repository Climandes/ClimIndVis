...
#'@param obs_p Station observations. Climindvis-object with type = "p" generated by make_object.
...
#'@param trendplots. No trendplots implemented in this graphic. Set to FALSE.
#'@param plotstart Numeric. Chosen start year of historic time series plot. For a reference period of e.g. 1981-2010 and a forecast for 2011, plotstart can be set to 2009 and only 2009-2010 and the forecast 2011 is displayed.
#'@section Details:
...
autoplot_forecast_spi<-function(obs_p, fc_p,
                               index = "spi_forecast",index_args,selpoints=NULL,
  ...
  plot_spi_forecast(ind_dat,full_dat_NA,selpoints=selpoints, pdims=pdims, plotdir=plotdir,output=output,plotname=plotname,plotstart = plotstart,text_cex=text_cex,plot_title=plot_title,title=title,...)
