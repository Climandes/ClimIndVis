...
This function allows you to visualize the trend of indices, omitting val?ues where the trend is not significant. 
...
The color indicates the magnitude of the trends, for stations trends, the size of the triangle is also proportional to the absolute magnitude and the direction indicates the trend direction. 
...
```{r trend_map_plots, fig.width=3.3, fig.height=2.5,fig.show='hold',echo=FALSE}
...
```
The figures show the trends of the seasonal mean minimum temperature for seasons "DJF" and "JJA".
...
***Example figures will be added soon!***
